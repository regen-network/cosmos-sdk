...
// SetupDeliverTx will do general initialization. Can be used even if you want to call
// NewSimApp with other args than Setup defaults
func SetupDeliverTx(app *SimApp) {
