...
func NewSimApp(
	...
	// TODO: Remove cdc in favor of amino once all modules are migrated.
	...
	app.ParamsKeeper = params.NewKeeper(amino, keys[params.StoreKey], tkeys[params.TStoreKey])
	...
	app.CapabilityKeeper = capability.NewKeeper(amino, keys[capability.StoreKey], memKeys[capability.MemStoreKey])
	scopedIBCKeeper := app.CapabilityKeeper.ScopeToModule(ibc.ModuleName)
	scopedTransferKeeper := app.CapabilityKeeper.ScopeToModule(transfer.ModuleName)

	// add keepers
	app.AccountKeeper = auth.NewAccountKeeper(
		amino, keys[auth.StoreKey], app.subspaces[auth.ModuleName], auth.ProtoBaseAccount, maccPerms,
	)
	app.BankKeeper = bank.NewBaseKeeper(
		amino, keys[bank.StoreKey], app.AccountKeeper, app.subspaces[bank.ModuleName], app.BlacklistedAccAddrs(),
	)
	stakingKeeper := staking.NewKeeper(
		amino, keys[staking.StoreKey], app.AccountKeeper, app.BankKeeper, app.subspaces[staking.ModuleName],
	)
	app.MintKeeper = mint.NewKeeper(
		amino, keys[mint.StoreKey], app.subspaces[mint.ModuleName], &stakingKeeper,
		app.AccountKeeper, app.BankKeeper, auth.FeeCollectorName,
	)
	app.DistrKeeper = distr.NewKeeper(
		amino, keys[distr.StoreKey], app.subspaces[distr.ModuleName], app.AccountKeeper, app.BankKeeper,
		&stakingKeeper, auth.FeeCollectorName, app.ModuleAccountAddrs(),
	)
	app.SlashingKeeper = slashing.NewKeeper(
		amino.Amino, keys[slashing.StoreKey], &stakingKeeper, app.subspaces[slashing.ModuleName],
	)
	app.CrisisKeeper = crisis.NewKeeper(
		app.subspaces[crisis.ModuleName], invCheckPeriod, app.BankKeeper, auth.FeeCollectorName,
	)
	app.UpgradeKeeper = upgrade.NewKeeper(skipUpgradeHeights, keys[upgrade.StoreKey], amino, homePath)
	...
	app.GovKeeper = gov.NewKeeper(
		amino, keys[gov.StoreKey], app.subspaces[gov.ModuleName], app.AccountKeeper, app.BankKeeper,
	...
	app.IBCKeeper = ibc.NewKeeper(
		app.cdc, amino, keys[ibc.StoreKey], app.StakingKeeper, scopedIBCKeeper,
	)

	// Create Transfer Keepers
	app.TransferKeeper = transfer.NewKeeper(
		amino, keys[transfer.StoreKey],
	...
	evidenceKeeper := evidence.NewKeeper(
		amino, keys[evidence.StoreKey], &app.StakingKeeper, app.SlashingKeeper,
	)
	...
	app.mm = module.NewManager(
		...
		auth.NewAppModule(amino, app.AccountKeeper),
		bank.NewAppModule(amino, app.BankKeeper, app.AccountKeeper),
		capability.NewAppModule(amino, *app.CapabilityKeeper),
		crisis.NewAppModule(&app.CrisisKeeper),
		gov.NewAppModule(amino, app.GovKeeper, app.AccountKeeper, app.BankKeeper),
		mint.NewAppModule(amino, app.MintKeeper, app.AccountKeeper),
		slashing.NewAppModule(amino, app.SlashingKeeper, app.AccountKeeper, app.BankKeeper, app.StakingKeeper),
		distr.NewAppModule(amino, app.DistrKeeper, app.AccountKeeper, app.BankKeeper, app.StakingKeeper),
		staking.NewAppModule(amino, app.StakingKeeper, app.AccountKeeper, app.BankKeeper),
