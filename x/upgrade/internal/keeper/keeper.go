...
func DeleteUpgradeFile(upgradeInfoFilePath string) error {
...
func (k Keeper) UpgradeStoreLoader(upgradeHeight int64, storeUpgrades *store.StoreUpgrades) baseapp.StoreLoader {
